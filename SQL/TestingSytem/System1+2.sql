...
value
(1,'phunthang1@gmail.com','thang','phungminhthang1',1,'2000-1-1'),
(2,'phungthang2@gmail.com','thang2','phungminhthang2','2000-2-2'),
(3,'phunthang3@gmail.com','thang3','phungminhthang3',3,3,'2000-3-3'),
(4,'phunthang4@gmail.com','thang4','phungminhthang4',4,4,'2000-4-4'),
(5,'phunthang5@gmail.com','thang5','phungminhthang5',5,5,'2000-5-5');
...
value
(1,N'lý thuyết',1,1,1,'2000-1-1'),
(2,N' ý nghĩa',2,2,2,'2000-2-2'),
(3,N'vận dụng ',3,3,3,'2000-3-3'),
(4,N'các sử dụng',4,4,4,'2000-4-4'),
(5,N'lí do ',5,5,5,'2000-5-5');
...
create table if not exists `Exam`(
 ...
 alter table `Exam` change column `Duration` `duration` int ;
 insert into Exam(`Code`,Title,CategoryID,Duration,CreatorID,CreateDate)
 value
 ('vt01',N'kiểm tra cuối kì 1',1,80,1,'2000-1-1'),
 ('vti01',N'kiểm tra giữa kì 1',2,60,2,'2000-2-2'),
 ('vti03',N'kiểm tra cuối kì 2',3,75,3,'2000-3-3'),
