...
public class MobishopTransaction implements Serializable {
    ...
    public MobishopTransaction() {
    }

    public MobishopTransaction(String invoiceOrderID, String transactionID, String sourceReceiptID,
                               ...
                               String productServiceCode, String productID, String productCode, String productName,
                               String productDetail, String description, String productAccount, int amount,
                               int quantity, String saleDiscount, String saleFee, int grandAmount, int fee,
                               ...
                               Date importDateTime, String bankReferenceData, String accountID, String userType,
