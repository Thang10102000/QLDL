...
public class SummarizeNotSucc implements Serializable {
    ...
    public SummarizeNotSucc() {
    }

    public SummarizeNotSucc(String rowid, String code, String profile_id, String status, Date sum_date,
                            Date created_time, Date init_time, String partner_status,
                            String partner_trans_id, int partner_quantity, int partner_amount,
                            String confirm_user, String created_user, String order_status_code,
                            String order_status, String related_account, String account_name,
                            String payment_amount, String related_fee, String fee,
                            String grand_amount, String sale_fee, String sale_discount,
                            int quantity, int amount, String product_account,
                            String description, String product_detail, String product_name,
                            String product_code, String product_id, String product_service_code,
                            String product_service_id, String bank_reference_id, String bank_code,
                            String partner_invoice_id, String partner_order_id, String partner_reference_id,
                            String partner_code, String pay_type_name, String pay_type,
                            String sale_order_id, String source_receipt_id,
        ...
        this.partner_quantity = partner_quantity;
    ...
    public SummarizeNotSucc(SummarizeNotSucc ett) {
        ...
        this.partner_status = ett.partner_status;
        this.partner_trans_id = ett.partner_trans_id;
        this.partner_quantity = ett.partner_quantity;
        this.partner_amount = ett.partner_amount;
    ...
    public int getPartner_quantity() {
        return this.partner_quantity;
    }

    public void setPartner_quantity(int partner_quantity) {
        this.partner_quantity = partner_quantity;
    }
    ...
    public void setPartner_amount(int partner_amount) {
        this.partner_amount = partner_amount;
    }
