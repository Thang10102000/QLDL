...
public class MismatchedTransaction implements Serializable {
    // mobishop data
    ...
    public MismatchedTransaction() {
    }

    public MismatchedTransaction(String invoiceOrderID, String transactionID, String sourceReceiptID, String saleOrderID, String payType, String payTypeName, String partnerCode, String partnerReferenceID, String partnerOrderID, String partnerInvoiceID, String bankCode, String bankReferenceID, String productServiceID, String productServiceCode, String productID, String productCode, String productName, String productDetail, String description, String productAccount, int amount, int quantity, String saleDiscount, String saleFee, int grandAmount, int fee, int relatedFee, int paymentAmount, String accountName, String relatedAccount, String orderStatus, String orderStatusCode, String createdUser, String confirmUser, Date initTime, Date createdTime, String fileName, Date logDateTime, Date importDateTime, String bankReferenceData, String accountID, String userType, Date endTime, Date transTime, String issuerBankCode, String profileID, String partnerTransID, String forcontrolCode, String partnerStatus, Date sumDate, Date adjustDate, String processStatus, String userProcess, String confirmStatus, String userConfirm, String refundStatus, String ticketName, String finalStatus) {
