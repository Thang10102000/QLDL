...
import vn.com.telsoft.model.PmgwTransactionModel;
...
@Named
@ViewScoped
public class PmgwTransactionController extends TSFuncTemplate implements Serializable {

    private List<PmgwTransaction> mlistApp;
    private PmgwTransaction mtmpApp;
    private List<PmgwTransaction> mselectedApp;
    private PmgwTransactionModel mmodel;
    private StreamedContent file;
    private final String strRealPath = FileUtil.getRealPath(JsfConstant.TEMP_FOLDER_TEMPLATE);
    private final String strFileTemplate = "pmgw_transaction_template.xlsx";
    private final String strFoderExport = FileUtil.getRealPath(JsfConstant.TEMP_FOLDER_FILE_EXPORT);
    private final String strPrefexFileName = "PMGW";
    private Date transDateFrom;
    private Date transDateTo;
    private String searchInput;

    private List<String> selectedCenterCodes = new ArrayList<>();

    public PmgwTransactionController() throws Exception {
        mmodel = new PmgwTransactionModel();
    ...
    public void changeStateAdd() throws Exception {
        ...
        mtmpApp = new PmgwTransaction();
    }
    //////////////////////////////////////////////////////////////////////////////////

    public void changeStateEdit(PmgwTransaction app) throws Exception {
        super.changeStateEdit();
        selectedIndex = mlistApp.indexOf(app);
        mtmpApp = (PmgwTransaction) SerializationUtils.clone(app);
    }
    //////////////////////////////////////////////////////////////////////////////////

    public void changeStateCopy(PmgwTransaction app) throws Exception {
...
//            mmodel.edit(mtmpApp);
    ...
    public void handleDelete(PmgwTransaction ett) throws Exception {
        //Check permission
        if (!getPermission("D")) {
            return;
        }
...
//        mlistApp = mmodel.getListApp();
    ...
    public void handleSearch() throws Exception {
        try {
            mlistApp = mmodel.getPmgwTransactions(
                    this.transDateFrom, this.transDateTo, this.selectedCenterCodes, this.searchInput);
    ...
    public void changeStateProcess(PmgwTransaction app) throws Exception {
        selectedIndex = this.mlistApp.indexOf(app);
        this.mtmpApp = (PmgwTransaction) SerializationUtils.clone(app);
    }
    ...
    //Getters
    public List<PmgwTransaction> getMlistApp() {
        return mlistApp;
    }

    public PmgwTransaction getMtmpApp() {
        return mtmpApp;
    }

    //Setters
    public void setMtmpApp(PmgwTransaction mtmpApp) {
        this.mtmpApp = mtmpApp;
    }

    public List<PmgwTransaction> getMselectedApp() {
        return mselectedApp;
    }

    public void setMselectedApp(List<PmgwTransaction> mselectedApp) {
    ...
    public void setMlistApp(List<PmgwTransaction> mlistApp) {
        this.mlistApp = mlistApp;
    }

    public PmgwTransactionModel getMmodel() {
        return mmodel;
    }

    public void setMmodel(PmgwTransactionModel mmodel) {
        this.mmodel = mmodel;
    }
    ...
    public List<String> getSelectedCenterCodes() {
        return selectedCenterCodes;
    }

    public void setSelectedCenterCodes(List<String> selectedCenterCodes) {
        this.selectedCenterCodes = selectedCenterCodes;
    }
}
