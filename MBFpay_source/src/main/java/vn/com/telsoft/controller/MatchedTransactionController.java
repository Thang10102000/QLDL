...
@Named
@ViewScoped
public class MatchedTransactionController extends TSFuncTemplate implements Serializable {

    private List<MatchedTransaction> mlistApp;
    private MatchedTransaction mtmpApp;
    private List<MatchedTransaction> mselectedApp;
    private MatchedTransactionModel mmodel;
    ...
    private final String strPrefexFileName = "GDCK_";
    ...
    public MatchedTransactionController() throws Exception {
        mmodel = new MatchedTransactionModel();
...
//        adjustedFromDate = calendar.getTime();
    ...
    public void onCellEdit(CellEditEvent event) {
        ...
        try {
            ...
            this.mlistApp = mmodel.getMatchedTransactions(this.selectedPaymentAcceptors, this.selectedBankCodes,
    ...
    public void changeStateAdd() throws Exception {
        ...
        mtmpApp = new MatchedTransaction();
    }
    //////////////////////////////////////////////////////////////////////////////////

    public void changeStateEdit(MatchedTransaction app) throws Exception {
        super.changeStateEdit();
        selectedIndex = mlistApp.indexOf(app);
        mtmpApp = (MatchedTransaction) SerializationUtils.clone(app);
    }
    //////////////////////////////////////////////////////////////////////////////////

    public void changeStateCopy(MatchedTransaction app) throws Exception {
...
//            mmodel.edit(mtmpApp);
    ...
    public void handleDelete(MatchedTransaction ett) throws Exception {
        //Check permission
        if (!getPermission("D")) {
            return;
        }
...
//        mlistApp = mmodel.getListApp();
    ...
    public void changeStateProcess(MatchedTransaction app) throws Exception {
        selectedIndex = this.mlistApp.indexOf(app);
        this.mtmpApp = (MatchedTransaction) SerializationUtils.clone(app);
    }
    ...
    public void confirmProcess(String input) throws Exception {
        try {
            ...
            //Bo sung
            if (input.equals("1") && this.mtmpApp.getProcessStatus().equals("3")) {
                mmodel.handleDeduction(mtmpApp);
            }
    ...
    //Getters
    public List<MatchedTransaction> getMlistApp() {
        return mlistApp;
    }

    public MatchedTransaction getMtmpApp() {
        return mtmpApp;
    }

    //Setters
    public void setMtmpApp(MatchedTransaction mtmpApp) {
        this.mtmpApp = mtmpApp;
    }

    public List<MatchedTransaction> getMselectedApp() {
        return mselectedApp;
    }

    public void setMselectedApp(List<MatchedTransaction> mselectedApp) {
    ...
    public Set<String> getDistinctOrderStatusCode(final List<MatchedTransaction> transactionList){
        Set<String> distinctStatusCode = new HashSet<>();
        for(final MatchedTransaction MatchedTransaction: transactionList){
            distinctStatusCode.add(MatchedTransaction.getOrderStatusCode());
        }
