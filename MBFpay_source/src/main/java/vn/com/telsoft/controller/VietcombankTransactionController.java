...
import vn.com.telsoft.model.VietcombankTransactionModel;
...
@Named
@ViewScoped
public class VietcombankTransactionController extends TSFuncTemplate implements Serializable {

    private List<VietcombankTransaction> mlistApp;
    private VietcombankTransaction mtmpApp;
    private List<VietcombankTransaction> mselectedApp;
    private VietcombankTransactionModel mmodel;
    private StreamedContent file;
    private final String strRealPath = FileUtil.getRealPath(JsfConstant.TEMP_FOLDER_TEMPLATE);
    private final String strFileTemplate = "Vietcombank_transaction_template.xlsx";
    private final String strFoderExport = FileUtil.getRealPath(JsfConstant.TEMP_FOLDER_FILE_EXPORT);
    private final String strPrefexFileName = "VIETCOMBANK_";
    ...
    public VietcombankTransactionController() throws Exception {
        mmodel = new VietcombankTransactionModel();
    ...
    public void changeStateAdd() throws Exception {
        ...
        mtmpApp = new VietcombankTransaction();
    }
    //////////////////////////////////////////////////////////////////////////////////

    public void changeStateEdit(VietcombankTransaction app) throws Exception {
        super.changeStateEdit();
        selectedIndex = mlistApp.indexOf(app);
        mtmpApp = (VietcombankTransaction) SerializationUtils.clone(app);
    }
    //////////////////////////////////////////////////////////////////////////////////

    public void changeStateCopy(VietcombankTransaction app) throws Exception {
...
//            mmodel.edit(mtmpApp);
    ...
    public void handleDelete(VietcombankTransaction ett) throws Exception {
        //Check permission
        if (!getPermission("D")) {
            return;
        }
...
//        mlistApp = mmodel.getListApp();
    ...
    public void handleSearch() throws Exception {
        try {
            mlistApp = mmodel.getVietcombankTransactions( this.transactionDateFrom, this.transactionDateTo,
    ...
    public void changeStateProcess(VietcombankTransaction app) throws Exception {
        selectedIndex = this.mlistApp.indexOf(app);
        this.mtmpApp = (VietcombankTransaction) SerializationUtils.clone(app);
    }
    ...
    //Getters
    public List<VietcombankTransaction> getMlistApp() {
        return mlistApp;
    }

    public VietcombankTransaction getMtmpApp() {
        return mtmpApp;
    }

    //Setters
    public void setMtmpApp(VietcombankTransaction mtmpApp) {
        this.mtmpApp = mtmpApp;
    }

    public List<VietcombankTransaction> getMselectedApp() {
        return mselectedApp;
    }

    public void setMselectedApp(List<VietcombankTransaction> mselectedApp) {
    ...
    public void setMlistApp(List<VietcombankTransaction> mlistApp) {
        this.mlistApp = mlistApp;
    }

    public VietcombankTransactionModel getMmodel() {
        return mmodel;
    }

    public void setMmodel(VietcombankTransactionModel mmodel) {
        this.mmodel = mmodel;
    }
