...
import vn.com.telsoft.model.VietinbankTransactionModel;
...
@Named
@ViewScoped
public class VietinbankTransactionController extends TSFuncTemplate implements Serializable {

    private List<VietinbankTransaction> mlistApp;
    private VietinbankTransaction mtmpApp;
    private List<VietinbankTransaction> mselectedApp;
    private VietinbankTransactionModel mmodel;
    private StreamedContent file;
    private final String strRealPath = FileUtil.getRealPath(JsfConstant.TEMP_FOLDER_TEMPLATE);
    private final String strFileTemplate = "vietinbank_transaction_template.xlsx";
    private final String strFoderExport = FileUtil.getRealPath(JsfConstant.TEMP_FOLDER_FILE_EXPORT);
    private final String strPrefexFileName = "VIETINBANK_";
    private Date transactionDateFrom;
    private Date transactionDateTo;
    private String searchInput;
    private List<String> selectedFileTypes = new ArrayList<>();

    public VietinbankTransactionController() throws Exception {
        mmodel = new VietinbankTransactionModel();
    ...
    public void changeStateAdd() throws Exception {
        ...
        mtmpApp = new VietinbankTransaction();
    }
    //////////////////////////////////////////////////////////////////////////////////

    public void changeStateEdit(VietinbankTransaction app) throws Exception {
        super.changeStateEdit();
        selectedIndex = mlistApp.indexOf(app);
        mtmpApp = (VietinbankTransaction) SerializationUtils.clone(app);
    }
    //////////////////////////////////////////////////////////////////////////////////

    public void changeStateCopy(VietinbankTransaction app) throws Exception {
...
//            mmodel.edit(mtmpApp);
    ...
    public void handleDelete(VietinbankTransaction ett) throws Exception {
        //Check permission
        if (!getPermission("D")) {
            return;
        }
...
//        mlistApp = mmodel.getListApp();
    ...
    public void handleSearch() throws Exception {
        try {
            mlistApp = mmodel.getVietinbankTransactions( this.transactionDateFrom, this.transactionDateTo,
    ...
    public void changeStateProcess(VietinbankTransaction app) throws Exception {
        selectedIndex = this.mlistApp.indexOf(app);
        this.mtmpApp = (VietinbankTransaction) SerializationUtils.clone(app);
    }
    ...
    //Getters
    public List<VietinbankTransaction> getMlistApp() {
        return mlistApp;
    }

    public VietinbankTransaction getMtmpApp() {
        return mtmpApp;
    }

    //Setters
    public void setMtmpApp(VietinbankTransaction mtmpApp) {
        this.mtmpApp = mtmpApp;
    }

    public List<VietinbankTransaction> getMselectedApp() {
        return mselectedApp;
    }

    public void setMselectedApp(List<VietinbankTransaction> mselectedApp) {
    ...
    public void setMlistApp(List<VietinbankTransaction> mlistApp) {
        this.mlistApp = mlistApp;
    }

    public VietinbankTransactionModel getMmodel() {
        return mmodel;
    }

    public void setMmodel(VietinbankTransactionModel mmodel) {
        this.mmodel = mmodel;
    }
